...
actionShortcuts = {
    ...
    'viewFullScreen'     : QKeySequence.StandardKey.FullScreen ,
    'viewGrid'           : 'G'                                 ,
    'viewTransparent'    : 'T'                                 ,
    'viewOpaque'         : 'O'                                 ,
    'viewPrev'           : QKeySequence.StandardKey.Back       ,
    'viewNext'           : QKeySequence.StandardKey.Forward    ,
    'viewZoomIn'         : QKeySequence.StandardKey.ZoomIn     ,
    'viewZoomOut'        : QKeySequence.StandardKey.ZoomOut    ,
    'viewZoomWindow'     : 'W'                                 ,
    'viewZoomFull'       : 'Home'                              ,
    'viewZoomSelection'  : '
