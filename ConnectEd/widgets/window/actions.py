...
class Actions:
    ...
    def __init__(self : Self) -> None:
        ...
        self.fileOpenMRU1       = Action( window(), "&1:"           , "Open recent file"                       , None                         )
        self.fileOpenMRU2       = Action( window(), "&2:"           , "Open recent file"                       , None                         )
        self.fileOpenMRU3       = Action( window(), "&3:"           , "Open recent file"                       , None                         )
        self.fileOpenMRU4       = Action( window(), "&4:"           , "Open recent file"                       , None                         )
        self.fileOpenMRU5       = Action( window(), "&5:"           , "Open recent file"                       , None                         )
        self.fileOpenMRU6       = Action( window(), "&6:"           , "Open recent file"                       , None                         )
        self.fileOpenMRU7       = Action( window(), "&7:"           , "Open recent file"                       , None                         )
        self.fileOpenMRU8       = Action( window(), "&8:"           , "Open recent file"                       , None                         )
        self.fileOpenMRU9       = Action( window(), "&9:"           , "Open recent file"                       , None                         )
        self.fileExit           = Action( window(), "Exit"          , "Exit the application"                   , SK.Quit                      )
        self.editCancel         = Action( window(), "Cancel"        , "Cancel current operation"               , SK.Cancel                    )
