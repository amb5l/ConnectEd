...
registerClass( _item_classes , "PropertyTextLineItem"  , "property_text" )
registerClass( _item_classes , "PropertyTextBlockItem" , "property_text" )
...
registerClass( _item_classes , "TextLineItem"          , "text"          )
registerClass( _item_classes , "TextBlockItem"         , "text"          )
