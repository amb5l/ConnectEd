...
TScene = TypeVar("TScene", bound=DiagramScene)


class DefinitionView(DiagramView, Generic[TScene]):
    # instance attributes
    _pen : QPen

    @checked
    def __init__(self : Self, scene : TScene) -> None:
...
class DefinitionSubWindow(DiagramSubWindow):
    @checked
    def __init__(
        self        : Self,
