...
class PaletteDark:
    ...
    Grid              = QColor("#404040")
    EntryUnconnected  = QColor("#404040")
    EntryConnected    = QColor("#FFFF00")
    EntryJunction     = QColor("#FF0000")
    VertexUnconnected = QColor("#FFFF00")
    VertexConnected   = QColor("#FFFF00")
    VertexJunction    = QColor("#FF0000")
...
class PaletteLightMono:
    ...
    Grid              = QColor("#E0E0E0")
    EntryUnconnected  = QColor("#000000")
    EntryConnected    = QColor("#000000")
    EntryJunction     = QColor("#000000")
    VertexUnconnected = QColor("#000000")
    VertexConnected   = QColor("#000000")
    VertexJunction    = QColor("#000000")
